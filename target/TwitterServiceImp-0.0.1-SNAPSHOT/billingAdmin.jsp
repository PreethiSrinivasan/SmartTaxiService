                ...
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                       ...
                       <!--  <li>
                        ...
                        <li>
                            <a href="Charts"><i class="fa fa-edit fa-fw"></i>Sensor Monitoring</a>
                        </li>
                         <!-- <li>
...
<!--                          <li> -->
<!--                             <a href="billingUser.jsp"><i class="fa fa-table fa-fw"></i> Billing for Sensor Consumer</a> -->
<!--                         </li> -->
                    </ul>
                </div>
                <!-- /.sidebar-collapse -->
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Billing for Sensor Consumer</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
...
<%
	...
	while(rs.next())
	{
 	   Date create_dt_2 = rs.getTimestamp("creation_date");
 	   Date last_update_dt_2 = rs.getTimestamp("lastUpdated");
 	   int  cost = rs.getInt("cost");
 	   long secs = (last_update_dt_2.getTime() - create_dt_2.getTime()) / 1000;
 	   long hours = secs / 3600; 
 	   long per_sensor_cost = (hours/24) * cost;
 	 String rev = Long.toString(per_sensor_cost);
